        ...
        <div style={{ background: "black" }}>
            <div className="row form_and_map_container">
                <div className="col-xl-5">
                    ...
                    <h3 className='pt-2' style={{ color: 'gray' }}><input type="checkbox" style={{ transform: "scale(2)" }} />&emsp; I agree to the <Link to="/" style={{ textDecoration: "underline", color: "white" }}>Terms & Conditions</Link></h3>
                    <button type="button" class="btn btn-warning py-2 mt-3 submit_btn" style={{ paddingLeft: "70px", paddingRight: "70px", color: "white" }}><b>Submit</b></button>
                </div>
